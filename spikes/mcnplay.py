...
from pyadept.rprotocol import create_robot_client, MCNClientProtocol
...
if __name__ == '__main__':
    ...
    client_coro, client_completed, stop_event = create_robot_client(loop, commands, '127.0.0.1', 1234)
